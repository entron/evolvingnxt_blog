...
BLOG_AUTHOR = "Cheng Guo"  # (translatable)
BLOG_TITLE = "Evolving NXT"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://entron.github.io/evolvingnxt_blog"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://evolvingnxt.blogspot.com/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "The notebook of my Lego Mindstorms NXT projects."  # (translatable)
